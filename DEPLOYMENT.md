...
The homepage uses Spotify’s official **track iframe** for [Clap Back](https://open.spotify.com/track/7jdM8H1Rx0LgHlqF5ezmCx) (`352px` tall). Embed URL and track id live in [`lib/site-config.ts`](./lib/site-config.ts).
